...
// dir ...
commandMap.set("dir", [(arguements_, console_) => {
...
// cd ...
commandMap.set("cd", [(arguements_, console_) => {
        if (arguements_.length <= 1) { // if only dir
...
// help
commandMap.set("help", [(arguements_, console_) => {
        console_.PrintLn(" ");
...
// clear
commandMap.set("clear", [(arguements_, console_) => {
        console_.ClearOut();
    },
    "clear : clear the terminal"]);
// run
commandMap.set("run", [(arguements_, console_) => {
        if (arguements_.length <= 1)
            return;
        let fileToRun = arguements_[1];
