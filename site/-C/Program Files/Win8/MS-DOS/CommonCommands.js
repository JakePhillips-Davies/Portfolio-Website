...
export class CommonCommands {
    static AddCommandsTo(terminal_) {
        // dir ...
        terminal_.AddToCommandMap("dir", [(arguements_) => {
        ...
        // cd ...
        terminal_.AddToCommandMap("cd", [(arguements_) => {
                if (arguements_.length <= 1) { // if only dir
        ...
        // help
        terminal_.AddToCommandMap("help", [(arguements_) => {
                terminal_.PrintLn(" ");
        ...
        // clear
        terminal_.AddToCommandMap("clear", [(arguements_) => {
                terminal_.ClearOut();
            },
            "clear : clear the terminal"]);
        // read
        terminal_.AddToCommandMap("read", [(arguements_) => {
                terminal_.PrintLn(" ");
                if (arguements_.length <= 1)
                    return;
                let filePath = "";
                if (arguements_[1].includes("-C\\") || arguements_[1].includes("-BIOS\\")) { }
                else
                    filePath += terminal_.CurrentPath() + "\\";
            ...
            "read : read a file"]);
        // run
        terminal_.AddToCommandMap("run", [(arguements_) => {
                if (arguements_.length <= 1)
                    return;
                let filePath = "";
                if (arguements_[1].includes("-C\\") || arguements_[1].includes("-BIOS\\")) { }
